  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.container2}>
        <Text style={{fontSize: 17, fontWeight:'500'}} numberOfLines={1}>{name}</Text>
        <Text style={{fontSize: 17, fontWeight: '900'}} numberOfLines={1}>$ {price}</Text>
      </View>
      ...
      <View style={styles.container3}>
        ...
        <TouchableOpacity onPress={() => increamentHandler(id, quantity, stock)}>
